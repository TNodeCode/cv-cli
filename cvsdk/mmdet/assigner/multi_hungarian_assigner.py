...
class MultiHungarianAssigner(TaskAlignedAssigner):
    ...
    def __init__(self,
                 *args: list,
                 cls_cost: dict=dict(type='FocalLossCost', weight=2.0),
    ...
    def assign(self,
        ...
        decode_bboxes: torch.Tensor=pred_instances.bboxes,
